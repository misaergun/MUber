...
class _NewTripScreenState extends State<NewTripScreen>
{
                  ...
                  children: [
                    ...
                    ElevatedButton.icon(
                      onPressed: () async
                      {
                        ...
                        //user is in the drivers car and trip starting /lets go button
                        ...
                        } //user and driver reached the drop off location //end trip
  ...
  endTripNow() async
  {
    ...
    //display fare amount in dialog box to driver
    showDialog(
        context: context,
  ...
  saveFareAmountToDriverEarnings(double totalFareAmount)
  {
        ...
        .then((snap)
    {
      ...
      else //earnings sub child doesnt exist
        {
        FirebaseDatabase.instance.ref()
        .child("drivers")
        .child(currentFirebaseUser!.uid)
